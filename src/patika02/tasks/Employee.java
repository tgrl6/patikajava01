...
Eğer çalışan 9yıldan az bir süredir çalışıyorsa maaşına %5 zam yapılacaktır.
...
public class Employee {
    ...
    public int totalmaas(){
       
        int totalmaas = (int) (salary+this.bonus()+this.raiseSallary()-this.tax());
